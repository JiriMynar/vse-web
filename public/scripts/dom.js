...
export function initializeRefs() {
  ...
  refs.workspaceMenuPrimary = document.getElementById("workspace-menu-primary");
  refs.workspaceHistoryPanel = document.getElementById("workspace-menu-history");
  refs.workspaceHistoryButton = document.getElementById("workspace-history-button");
  refs.workspaceHistoryBack = document.getElementById("workspace-history-back");
